...
public class DownLoadLinuxCZ extends HttpServlet {
    private static final long serialVersionUID = 1L;
    private Logger logger = Logger.getLogger(DownLoadLinuxCZ.class);
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            Version av = null;
            String android_version = StringContext.systemPath + "/client/linux/cz" + "/version.xml";
            ...
            msg = "下载linux车载 SSLVPN 客户端成功"+request.getRemoteAddr();
        } catch (Exception e) {
            e.printStackTrace();
            msg = "下载linux车载 SSLVPN 客户端失败"+request.getRemoteAddr();
            logger.error("下载linux车载 SSLVPN 客户端失败"+request.getRemoteAddr(), e);
        }
