 ...
 */
public class SSLVpnKickUserServlet extends HttpServlet{


    protected RequestHandler handler = new SSLVpnKickUserHandler();
    ...
    public void doPost(HttpServletRequest httpRequest,HttpServletResponse httpResponse)throws ServletException {
        ...
        String jsonrpc = httpRequest.getParameter("jsonrpc");
